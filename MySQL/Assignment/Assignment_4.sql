...
-- name “First Name", "Last Name.
    ...
    last_name as "Last Name" from employee;
-- ==================================================================================
...
-- the employees (PF is calculated as 15% of salary).
  select  first_name,last_name,salary,salary*0.15 from employee;
...
-- order.
 ...
 select first_name,last_name,department_id from employee where department_id in(30,100) order by department_id;
 -- ==================================================================================
-- 14.Write a query to display the name (first_name, last_name) and salary for
-- all employees whose salary is not in the range $10,000 through $15,000
-- and are in department 30 or 100.
select first_name,last_name,department_id from employee where salary not between 10000 and 50000  and department_id in(30,100);
 -- ==================================================================================
...
where job_id in ("it_prog","Shipping clear") And Salary not in(45000,10000,15000);
...
select * from employee where last_name in('BLAKE', 'SCOTT', 'KING' and 'FORD');